...
<style>
    ...
    <body class="Body">
       ...
       <div style="width:250px;height:200px;background-color: lightcoral;display:none;border-radius: 5px" id="drop">
        ...
        <div class="column1" style="margin-top:20px"><form method="post" action="displaycolgdetails.php" style="text-align: center">
              <p style="color:orange">college:   <select name='colgname'>
                <?php 
                $dbs=mysqli_connect('localhost','root','root','TEST');
