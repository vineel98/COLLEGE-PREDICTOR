    ...
    <body class="Body">
       ...
       <div style="width:250px;height:200px;background-color: lightcoral;display:none;border-radius: 5px" id="drop">
        ...
        <div class="column1" style="margin-top:20px">
           <p style="color:orange;font-family: fantasy;font-size: 20px">
                 Hi! Admin welcome back. Hope the students are getting benefited by your site.
                 you can make your site more useful to them by updating the existing college information
                 or by adding new colleges to your database. This can be done by clicking on your profile pic on the 
                 top right corner.
                 Thanking you 
                 <t/>-site developer.
           </p>
