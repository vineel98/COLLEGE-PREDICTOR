        ...
        <div class="column1" style="margin-top:20px">
            <table border="0.3" style="width:100%">
                <tr>
                    ...
                    <td>
                        <p style="color:orange"><?php echo $a['std_name']; ?></p>
S                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                       <p style="color:orange"> <?php echo $a['mobile'];?></p>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                      <p style="color:orange"><?php echo $a['email'];?></p>
                ...
                <tr>
                    ...
                    <td>
                        <p style="color:orange"><?php echo $a['rank'];?></p>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <p style="color:orange"><?php echo $a['dob'];?></p>
                    </td>
                 ...
                 <tr>
                    ...
                    <td>
                        <p style="color:orange"><?php echo $a['gender'];?></p>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <p style="color:orange"> <?php echo $a['usr_id'];?> </p>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <p style="color:orange"> <?php echo $a['pwd'];?> </p>
