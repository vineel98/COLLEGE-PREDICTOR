...
<style>
    ...
    <body class="Body">
       ...
       <div style="width:250px;height:200px;background-color: lightcoral;display:none;border-radius: 5px" id="drop">
        ...
        <div class="column1"><form method="post" action="displaystddetails.php" style="text-align: center"  >
                <p style="color:orange">Rank Of Student:   <select name='rank'>
                    <?php 
                     $q="select rank from student ";
                     $r=mysqli_query($dbs,$q);
                    if($r)
                    {
